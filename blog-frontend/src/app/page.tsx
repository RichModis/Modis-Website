    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto p-4 text-gray-800">
        <h1 className="text-3xl font-bold mb-6" style={{ color: '#E94F37' }}>
          Modis - Architectural Development Advice
        </h1>

        <form
          onSubmit={handleSubmit}
          className="mb-8 p-4 border-gray-300 border rounded bg-white text-gray-800"
        >
          ...
          <input
            ...
            className="w-full p-2 mb-2 border-gray-300 border rounded"
            required
          />
          <textarea
            placeholder="Content"
            ...
            className="w-full p-2 mb-2 border-gray-300 border rounded h-24"
            required
          />
          <button
            type="submit"
